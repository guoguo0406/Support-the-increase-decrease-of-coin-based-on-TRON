...
package com.changyo.common.runtime.vm;

import static com.changyo.common.runtime.utils.MUtil.convertToTronAddress;
import static com.changyo.common.utils.ByteUtil.parseWord;

import com.changyo.common.crypto.ECKey;
import com.changyo.common.utils.BIUtil;
import com.changyo.common.utils.ByteArray;
import com.changyo.common.utils.ByteUtil;
...
import com.changyo.common.crypto.zksnark.BN128;
import com.changyo.common.crypto.zksnark.BN128Fp;
import com.changyo.common.crypto.zksnark.BN128G1;
import com.changyo.common.crypto.zksnark.BN128G2;
import com.changyo.common.crypto.zksnark.Fp;
import com.changyo.common.crypto.zksnark.PairingCheck;
import com.changyo.common.runtime.vm.program.Program;
import com.changyo.common.runtime.vm.program.ProgramResult;
import com.changyo.common.storage.Deposit;
import com.changyo.core.actuator.Actuator;
import com.changyo.core.actuator.ActuatorFactory;
import com.changyo.core.actuator.ProposalApproveActuator;
import com.changyo.core.actuator.ProposalCreateActuator;
import com.changyo.core.actuator.ProposalDeleteActuator;
import com.changyo.core.actuator.VoteWitnessActuator;
import com.changyo.core.actuator.WithdrawBalanceActuator;
...
import com.changyo.protos.Contract.VoteWitnessContract;
  ...
  public static class ProposalCreateNative extends PrecompiledContract {
    ...
    public Pair<Boolean, byte[]> execute(byte[] data) {
      ...
      while (index <= data.length - 1) {
        ...
        parametersMap.put(ByteArray.toLong(id), ByteArray.toStr(value));
        index += 64;
      }
